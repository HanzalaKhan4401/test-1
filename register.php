...
if(isset($_POST['register'])){
  ...
  $email_ckeck = "select * from admin rigister where email = '$email'";
  $result = mysqli_querry($conn, $email_check);
  if(mysqli_num_rows($result)> 0){
    echo "<script>alert('Email already exist')</script>";
  }
  else{
    $insert_query = "INSERT INTO `Admin Register` (`username`, `email`, `password`) VALUES ('$username', '$email', '$password')";
    $conn_insert = mysqli_querry($conn, $insert_query);
  }
}
?> 
